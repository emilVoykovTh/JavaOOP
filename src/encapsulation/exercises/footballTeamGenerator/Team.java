...
public class Team {
    //+	addPlayer(Encapsulation.Exercises.footballTeamGenerator.Player) : void
    ...
    public void removePlayer(String playerName){
        ...
        if (containsPlayerName){
            ...
            throw new IllegalArgumentException("Encapsulation.Exercises.footballTeamGenerator.Player "+ playerName +" is not in Arsenal team.");
        }
    }
